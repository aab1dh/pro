import { g as getRenderingRef, i as forceUpdate, e as Build } from './p-c03ea8d2.js';
...
const fetch$1 = (window.fetch = async (...args) => {
...
const get = prop => store.get(prop);
const set = (prop, value) => store.set(prop, value);
const store$1 = store.state;
...
class FetchProvider {
  async get() {
    ...
    try {
      const res = await fetch$1(url, { signal: controller.signal });
...
export { FetchProvider as F, createStore as c, loadTranslation as l, registerGlobalErrorHandler as r, translation as t };
